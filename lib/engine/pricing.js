export const PRICING_DATA = {
  ...
  "google": {
    ...
    // gemini-2.5-pro is tiered by context size (<=200K: 1.25/10.00, >200K: 2.50/15.00) — this
    // calculator has no tiering support, so the <=200K rate is used flat. Track 009.
